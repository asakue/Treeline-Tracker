...
**Treeline Tracker** — Защищенная система обеспечения безопасности, мониторинга и координации туристических групп в условиях дикой природы с гибридным транспортом передачи данных (Internet / Mesh-сети) и содействием поисково-спасательным операциям (SAR).

---

## 🧭 Навигация по разделам

### 📐 [Главная архитектурная спецификация](./architecture.md)
* [Архитектура системы, C4, RBAC, Схемы Firestore, Real-time и ИИ](./architecture.md)
...
* [Команда проекта](./01-product/team.md) — профиль команды (Дмитрий, Даниил, Илья, Александр, Кирилл), зоны ответственности и инженерные принципы.
...
* [Системная архитектура](./03-architecture/system.md) — многоуровневая архитектура C4.
* [Фронтенд-архитектура](./03-architecture/frontend.md) — разделение на UI, Application и Domain слои.
* [Бэкенд и хранение данных](./03-architecture/backend.md) — абстракция репозиториев, Firestore и Local Storage.
...
* [Модель угроз (Threat Model)](./04-security/threat-model.md) — классификация ассетов, акторов, защита секретов и ИИ-гардрейлы.
* [Идентификация и RBAC-модель](./04-security/identity.md) — роли пользователей (`hiker`, `guide`, `rescuer`, `admin`) и Custom Claims.
